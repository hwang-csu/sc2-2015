...
/* DASF markings */
#define TAINT_CLASSIFIED	((u4)0x00010000) /* Classified Data */
#define TAINT_SECRET		((u4)0x00020000) /* Secret Data */
#define TAINT_TOPSECRET		((u4)0x00040000) /* Top Secret Data */
