...
//BEGIN Register MedicalDeviceInitService (DASF)
			try {
    			Slog.i(TAG, "Medical Device Initialization Service");
    			ServiceManager.addService("med_dev_init", new MedicalDeviceInitService(context));
			} catch (Throwable e) {
			   Slog.e(TAG, "Failure starting MedicalDeviceInit Service", e);
			}
//END Register MedicalDeviceInitServices (DASF)
